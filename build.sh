...
FetchWebDev() {
  curl -L https://codeload.github.com/qq2474332446/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/qq2474332446/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
